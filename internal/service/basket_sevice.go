...
func NewBasketService(repo storage.Basket) *BasketService {
...
func (s *BasketService) CreateCurrencyTable(name string) error {
	return s.repo.CreateCurrencyTable(name)
}
